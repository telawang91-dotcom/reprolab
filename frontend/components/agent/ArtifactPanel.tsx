  ...
  return <>
    ...
    <Sheet open={harvestOpen} onOpenChange={setHarvestOpen} title="沉淀为可复用技能" side="bottom">
      <div className="mx-auto max-w-2xl space-y-5">
        <div className="flex items-start gap-3 rounded-apple bg-status-ok/[.08] p-4 text-sm text-status-ok"><ShieldCheck size={17} className="mt-0.5 shrink-0"/><span><strong>可信来源已锁定。</strong> 系统会从运行代码识别语义字段，保留受控数据加载与产物登记协议；应用到新数据时仍会重新执行。</span></div>
